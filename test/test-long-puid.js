...
describe('test long puid', function () {
    ...
    describe('getCounter', function () {
        ...
        it('two request should not be equal', function () {
            pid.getCounter()
                .should.not.equal(pid.getCounter());
        });
    ...
    describe('generate base36 string', function () {
        it('should be result in sexhex values', function () {
            pid.toBase36String('22')
                .should.be.equal('0m');
            pid.toBase36String('22', 2)
                .should.be.equal('0m');
            pid.toBase36String('22', 3)
                .should.be.equal('00m');
            pid.toBase36String('22', 'foobar')
                .should.be.equal('0m');
            pid.toBase36String('1000000', 5)
                .should.be.equal('0lfls');
            pid.toBase36String('10000000000', 8)
                .should.be.equal('04ldqpds');
            pid.toBase36String('10000000000', 9)
                .should.be.equal('004ldqpds');
